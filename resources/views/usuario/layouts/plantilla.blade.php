...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('https://fonts.googleapis.com/css?family=Montserrat:400,400i,700,700i,600,600i') }}">
    ...
    <link rel="stylesheet"
        href="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.10.0/baguetteBox.min.css') }}">
...
<body>
    ...
    <script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.10.0/baguetteBox.min.js') }}">
    </script>

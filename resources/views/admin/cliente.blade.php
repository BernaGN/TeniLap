    ...
    <body class="no-skin">
                                            ...
                                            <td>
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    <form action="{{route('clientes.destroy', $cliente->id)}}" method="post">
                                                        <button class="btn btn-xs btn-success" type="button" data-id_cliente="{{$cliente->id}}" data-nombre="{{$cliente->nombre}}" data-email="{{$cliente->email}}" data-telefono="{{$cliente->telefono}}" data-status="{{$cliente->estado}}" data-toggle="modal" data-target="#abrirmodalmostrar">
                                                            <i class="ace-icon fa fa-check bigger-120"></i>
                                                        </button>

                                                        <button class="btn btn-xs btn-info" type="button" data-id_cliente="{{$cliente->id}}" data-nombre="{{$cliente->nombre}}" data-email="{{$cliente->email}}" data-telefono="{{$cliente->telefono}}" data-status="{{$cliente->estado}}" data-toggle="modal" data-target="#abrirmodaleditar">
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('clientes.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                            @csrf
        ...
        <div class="modal fade" id="abrirmodaleditar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('clientes.update', 'test')}}" method="post" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                            @csrf
                            @method('PUT')
        ...
        <script type="text/javascript">
            ...
            $('#abrirmodalmostrar').on('show.bs.modal', function (event) {
               ...
               $(".modal-body #localidad").prop("readonly", true);
               $(".modal-body #localidad").attr("readonly", true);
           })
        </script>
    </body>
@endsection
